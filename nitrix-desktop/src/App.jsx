...
export default function App() {
  ...
  const initializeApp = async () => {
    const results = await Promise.allSettled([
      ...
      fetchProjects(),
      fetchSystemInfo(),
      window.electronAPI ? window.electronAPI.getAppVersion() : Promise.resolve(''),
    ]);

    const [statusResult, projectsResult, sysInfoResult, versionResult] = results;
    ...
    if (sysInfoResult.status === 'fulfilled') {
      setSysInfo(sysInfoResult.value);
    } else {
      addNotification('Failed to load system info', 'error');
    }
              ...
              <div className="flex items-center">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Train Smarter AI</p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="text-center">
              <p className="text-gray-400 text-sm">
                &copy; {new Date().getFullYear()} Nitrix &mdash; Beta Version
              </p>
