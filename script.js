...
// Download URLs - Updated with GitHub Releases
const DOWNLOAD_URLS = {
    macos: 'https://github.com/Starbird265/agent/releases/download/v1.0.0/Nitrix-1.0.0-arm64.dmg',
    windows: 'https://github.com/Starbird265/agent/releases/download/v1.0.0/Nitrix-Setup-1.0.0.exe',
    linux: 'https://github.com/Starbird265/agent/releases/download/v1.0.0/Nitrix-1.0.0-arm64.AppImage'
};
